...
Warning : Some of those are not available yet, including sget, sset, sgetrel, ssetrel, call, ret, lcreate, lstore, lload. They will be available in future commits. sget, sset, sgetrel, ssetrel are already implemented but not yet pushed.
...
| add     | Add                        | Adds the two top values from the stack and pushes the result.                        | 2              | 1               | Unused         | a, b                  |
...
| mul     | Multiply                   | Multiply the two top value from the stack.                                           | 2              | 1               | Unused         | a, b                  |
